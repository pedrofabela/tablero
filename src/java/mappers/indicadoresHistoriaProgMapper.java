 ...
 * @author pedro
 */
public class indicadoresHistoriaProgMapper implements Mapper{
     public Object mapRow(ResultSet rs) throws SQLException {
        ...
        if (rs.getString("ID_COLOR") != null) {
            cat.setID_COLOR(rs.getString("ID_COLOR").trim());
        } else {
            cat.setID_COLOR(rs.getString("ID_COLOR"));
        }
